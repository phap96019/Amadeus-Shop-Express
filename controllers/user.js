...
exports.store = async (req, res) => {
  try {
    ...
    let html = `<p>Hi ${user.email}<p><br><p>A new account has been created for you on ${domain}. Please click on the following <a href="${link}">link</a> to set your password and login.</p> 
